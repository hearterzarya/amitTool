...
import { googleSignIn, getCurrentUser, isLoggedIn } from '@/lib/firebase-auth';
...
/**
 * Client-side Firebase Google Sign-in Button
 * Uses Firebase Authentication (alternative to NextAuth)
